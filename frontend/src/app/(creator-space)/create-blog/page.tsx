        ...
        <main className="min-h-screen overflow-y-auto bg-[#0A0A0B] text-white relative flex flex-col">
            ...
            <div className="flex-1 w-full max-w-7xl mx-auto px-6 pb-20 relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 flex flex-col">
                    ...
                    {!coverImage ? (
                        <button className="w-full h-48 md:h-64 rounded-2xl border-2 border-dashed border-white/10 hover:border-white/30 bg-white/5 hover:bg-white/10 transition-all mb-10 flex flex-col items-center justify-center gap-4 group cursor-pointer">
                        ...
                        <div className="w-full h-48 md:h-64 rounded-2xl mb-10 relative overflow-hidden group">
